...
namespace prueba
{
    public partial class FormCompras : Form
    {
        ...
        {
            TablaVerDatos buscar = new TablaVerDatos("compras", arregloCodigos);
            buscar.ShowDialog();
        ...
        void interfazConClases()
        {
            ...
            MySqlCommand Llenar = new MySqlCommand("select indicadores, ref1, ref2, ref3, ref4, valor1, valor2, frecuenciaMedicion, cod, porcentaje, estado from nombreindicadores where area like '%compras%'", conectar);
            ...
            foreach (DataRow fila in tabla.Rows)
            {
                ...
                if (Convert.ToString(fila[6]) == "" && Convert.ToString(fila[10]) == "activo")
                {
                    ...
                    txtResultado.BackColor = Color.Linen;
                ...
                else if (Convert.ToString(fila[6]) != "" && Convert.ToString(fila[10]) == "activo")
                {
                    ...
                    lbPorcentaje.Text = Convert.ToString(fila[9]);
