...
namespace prueba
{
    public partial class FormContabilidad : Form
    {
        ...
        private void FormContabilidad_Load(object sender, EventArgs e)
        {
            interfazConClases();
            string area = "contabilidad";
            ...
            void AgregarHandler(object send, EventArgs eve)
            {
                ...
                FormContabilidad_Load(sender, e);
            }
        ...
        {
            TablaVerDatos buscar = new TablaVerDatos("contabilidad", arregloCodigos);
            buscar.ShowDialog();
