...
namespace prueba
{
    public partial class FormTecnologia : Form
    {
        ...
        private void FormTecnologia_Load(object sender, EventArgs e)
        {
            interfazConClases();
            string area = "tecnologias";
        ...
        {
            TablaVerDatos buscar = new TablaVerDatos("tecnologias", arregloCodigos);
            buscar.ShowDialog();
